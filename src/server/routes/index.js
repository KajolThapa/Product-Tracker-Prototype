...
const apiKey = 'l08bn0g524vn5yq1ruzwz9jpojaykt'
...
function formatUPCResult(response) {
    ...
    const { barcode_number, product_name, manufacturer, brand, description, images } = product; // let's limit the data we pass into the api
    return { barcode_number, product_name, manufacturer, brand, description, images };
}
